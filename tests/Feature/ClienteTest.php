...
class ClienteTest extends TestCase
{
    ...
    protected string $endpoint = '/api/clientes';
    ...
    public function testViewAllDummiesSuccessfully(): void
    {
        ...
        $this->json('GET', $this->endpoint)
             ...
             ->assertSee(Cliente::first(rand(1, 5))->name);
    }
    ...
    public function testsCreateClienteValidation(): void
    {
        $this->markTestIncomplete('This test case needs review.');
    ...
    public function testViewClienteData(): void
    {
        $this->markTestIncomplete('This test case needs review.');
    ...
    public function testRestoreCliente(): void
    {
        $this->markTestIncomplete('This test case needs review.');
    ...
    public function testPermanentCliente(): void
    {
        $this->markTestIncomplete('This test case needs review.');
